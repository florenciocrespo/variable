...
exports.create = function(req,res){
  ...
  var calidad = req.body.calidad,
      ...
      FCR = req.body.FCR,
      AV = req.body.AV,
      calidadM = req.body.calidadM,
      insatisfechosM = req.body.insatisfechosM,
      NDAM = req.body.NDAM,
      NDSM = req.body.NDSM,
      FCRM = req.body.FCRM,
      AVM = req.body.AVM,
      calidadJN = req.body.calidadJN,
      insatisfechosJN = req.body.insatisfechosJN,
      NDAJN = req.body.NDAJN,
      NDSJN = req.body.NDSJN,
      FCRJN = req.body.FCRJN,
      AVJN = req.body.AVJN,
   ...
   models.Variable.findAll().then(
      function(variables) {
        res.render('variables/calcular', { variables: variables,
          ...
          AV: AV,
          calidadM: calidadM,
          insatisfechosM: insatisfechosM,
          NDAM: NDAM,
          NDSM: NDSM,
          FCRM: FCRM,
          AVM: AVM,
          calidadJN: calidadJN,
          insatisfechosJN: insatisfechosJN,
          NDAJN: NDAJN,
          NDSJN: NDSJN,
          FCRJN: FCRJN,
          AVJN: AVJN,
